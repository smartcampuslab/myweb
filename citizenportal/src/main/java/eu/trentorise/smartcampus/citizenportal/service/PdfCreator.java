...
public class PdfCreator {
	...
	public PdfCreator(String path, java.util.List<UserClassificationProv> data,
			java.util.List<UserClassificationFinal> data2, FinancialEd edFin,
			String phase) {
	...
	private static void addContent(Document document) throws DocumentException {
		...
		Anchor edFinPer = new Anchor("Edizione: " + edFin.getPeriod(),
				smallBold);
		Anchor edFinCat = new Anchor("Categoria: " + edFin.getCategory(),
				smallBold);
		Anchor edFinTool = new Anchor("Strumento: " + edFin.getTool(),
				smallBold);
	...
	private static void createTable(Section subCatPart)
		...
		if (listClass != null) {
			for (int i = 0; i < listClass.size(); i++) {
				...
				PdfPCell cId = new PdfPCell(new Phrase(listClass.get(i)
						.getPracticeId()));
				...
				PdfPCell cComps = new PdfPCell(new Phrase(
						String.valueOf(listClass.get(i).getFamComponents())));
				cComps.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table.addCell(cComps);
				// Cell for score
				PdfPCell cScore = new PdfPCell(new Phrase(listClass.get(i)
						.getScore()));
			...
			for (int i = 0; i < listClassFinal.size(); i++) {
				// Cell for position
				table.addCell(String.valueOf(listClassFinal.get(i)
						.getPosition()));
				// Cell for practice id
				PdfPCell cId = new PdfPCell(new Phrase(listClassFinal.get(i)
						.getPracticeId()));
				cId.setHorizontalAlignment(Element.ALIGN_CENTER);
				table.addCell(cId);
				// Cell for ric_name
				...
				PdfPCell cComps = new PdfPCell(
						new Phrase(String.valueOf(listClassFinal.get(i)
								.getFamComponents())));
				cComps.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table.addCell(cComps);
				// Cell for score
				PdfPCell cScore = new PdfPCell(new Phrase(listClassFinal.get(i)
						.getScore()));
				cScore.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table.addCell(cScore);
			}
