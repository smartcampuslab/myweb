...
@Document(collection="user_class_final") 	
public class UserClassificationFinal {
	...
	public UserClassificationFinal() {
		// TODO Auto-generated constructor stub
	}

	public UserClassificationFinal(int position, String practiceId,
			String financialEdCode, String ricName, int famComponents,
			String score) {
		super();
